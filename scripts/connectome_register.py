...
"""
hcpmmp1_parcels_coreg = mif("a2009s_parcels_coreg")
hcpmmp1_parcels_nocoreg = mif("a2009s_parcels_nocoreg")


fscall("mri_surf2surf --srcsubject fsaverage --trgsubject", subject_name, "--hemi lh --sval-annot $SUBJECTS_DIR/fsaverage/label/lh.aparc.a2009s.annot --tval $SUBJECTS_DIR/"+subject_name+"/label/lh.aparc.a2009s.annot")
fscall("mri_surf2surf --srcsubject fsaverage --trgsubject", subject_name, "--hemi rh --sval-annot $SUBJECTS_DIR/fsaverage/label/rh.aparc.a2009s.annot --tval $SUBJECTS_DIR/"+subject_name+"/label/rh.aparc.a2009s.annot")
fscall("mri_aparc2aseg --old-ribbon --s", subject_name, "--annot aparc.a2009s --o", anyfile("a2009s",".mgz"))
mrcall("mrconvert -force -datatype uint32", anyfile("a2009s",".mgz"), mif("a2009s"))
mrcall("labelconvert -force", mif("a2009s"), "/imaging/local/software/freesurfer/latest/x86_64/FreeSurferColorLUT.txt /imaging/local/software/mrtrix/v3.0.3_nogui/share/mrtrix3/labelconvert/fs_a2009s.txt", hcpmmp1_parcels_nocoreg)
...
hcpmmp1 = csv("a2009s")
assignments_hcpmmp1 = csv("assignments_a2009s")
