...
def neuroCombat(data,
    ...
    print("Starting modified combat..")
    ...
    print("| Standardised data:", s_data)
    print("| Standardised data mean:", s_mean)
    print("| Standardised data: pool", v_pool)
