...
if os.path.exists(T1_raw):
	...
	call("yes 1 |", path_mrtrix+"mrconvert", path_in + foldername, T1_raw)
...
if os.path.exists(hcpmmp1_parcels_coreg):
	...
	mrcall("mrtransform", hcpmmp1_parcels_nocoreg, "-linear", diff2struct_mrtrix, "-inverse -datatype unit32", mif("hcpmmp1_parcels_coreg"))
